...
int pin = acc.getPin();
int userBalance = acc.getBalance();
int maxWithdraw = acc.getMaximumWithdrawal();
%>
<html lang = "en">  
<head>  
<title> BALANCE </title>  
...
<div class="container">
  ...
  <div class="cancel">
  	<input type="button" class="menu-button" value="cancel" id="cancel" onclick="logOut();">
  </div>
  <div class="clear">
  ...
  <div class="screenopt1">
  	<label id="balchkmessage">Yes &nbsp;</label>
  </div>
  <div class="screenopt2">
  	<label id="withdrawmessage">No  &nbsp;</label>
  </div>
  <div class="screentext">
    <div class="screentextoutput">
    	<label id="screenmessage">Balance is &euro;<%=userBalance %>. <br/> Max withdrawal is &euro;<%= maxWithdraw%>.</label>
    </div>
    <div class="pinarea">
    	<label id="pinmessage">Additional Service?</label>
    </div>
  </div>
</div>
