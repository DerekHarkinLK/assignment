...
<%
String errMsg = "";
errMsg = (String)request.getAttribute("errorMsg") + "<br>" + "Cancel to return card";
%>
<html lang = "en">  
<head>  
<title> ATM </title>  
...
<div class="container">
  <div class="btn0">
  	<input type = "button" class="number-button" value = "0" onclick = ""> 
  </div>
  <div class="btn1">
  	<input type="button" class="number-button" value = "1" onclick="">  
  </div>
  <div class="btn2">
  	<input type = "button" class="number-button" value = "2" onclick = "">  
  </div>
  <div class="btn3">
  	<input type = "button" class="number-button" value = "3" onclick = ""> 
  </div>
  <div class="btn4">
  	<input type = "button" class="number-button" value = "4" onclick = "">
  </div>
  <div class="btn5">
  	<input type = "button" class="number-button" value = "5" onclick = "">  
  </div>
  <div class="btn6">
  	<input type = "button" class="number-button" value = "6" onclick = "">  
  </div>
  <div class="btn7">
  	<input type = "button" class="number-button" value = "7" onclick = "">  
  </div>
  <div class="btn8">
  	<input type = "button" class="number-button" value = "8" onclick = "">  
  </div>
  <div class="btn9">
  	<input type = "button" class="number-button" value = "9" onclick = "">  
  </div>
  <div class="cancel">
  	<input type="button" class="menu-button" value="cancel" id="cancel" onclick="cancelBtn();">
  </div>
  <div class="clear">
  	<input type="button" class="menu-button" value="clear" id="clear" onclick="">   
  </div>
  <div class="confirm">
  	<input type="button" class="menu-button" value="confirm" id="confirm" onclick = "">  
  </div>
  <div class="screen">
  ...
  <div class="screentext">
    <div class="screentextoutput">
    	<label id="screenmessage"><%=errMsg %></label>
    </div>
    <div class="pinarea">
